...
DATABASES = {
    'default': {
        ...
        'CONN_MAX_AGE': 600,
        'ATOMIC_REQUESTS': True,  # Transaction support
    }
}
...
# Admin Account
ADMIN_EMAIL = config('ADMIN_EMAIL', default='admin@tsu.ac.th')
...
CACHES = {
    'default': {
        ...
        'LOCATION': config('CELERY_BROKER_URL', default='redis://localhost:6379'),
    }
}
